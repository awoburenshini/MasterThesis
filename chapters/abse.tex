...
Material point method (MPM) is a numerical method for solving partial differential equations. In recent years, MPM has made tremendous progress in physical simulation. 
...
various physical phenomena can be coupled in a system. So, we can realize some scenario that have never been successfully simulated.
...
and unreal surface tension effects. Due to that the continuum often be represented by particles in MPM，it is difficult to define a feasible surface of particle clouds,
...
timestep, in order to obtain a table coupling with surface tension, damping terms are often added to the equations and implict schemes are used, which intensifies the numerical
